...
# Problèmes rencontrés
    ...
    rien ne fonctionnait même ce qui fonctionnait depuis des semaines, on a découvert qu'il s'agissait de la corruption du fichier data.csv, qui se vidait quand nnous l'utilisions, il était     toujours là mais vide, nous l'avons résolu quand même.
